...
-- The view doesn't actually have SECURITY DEFINER (views don't support it)
-- This script ensures the view is clean and properly defined

DROP VIEW IF EXISTS public.soft_deleted_schedules_monitor CASCADE;
