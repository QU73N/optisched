...
const TOAST_COLORS: Record<ToastType, { bg: string; border: string; icon: string; iconName: string }> = {
    success: { bg: 'rgba(16,185,129,0.15)', border: '#3FAF73', icon: '#34d399', iconName: 'check-circle' },
    error: { bg: 'rgba(239,68,68,0.15)', border: '#E05D5D', icon: '#f87171', iconName: 'error' },
    warning: { bg: 'rgba(245,158,11,0.15)', border: '#E6A23C', icon: '#fbbf24', iconName: 'warning' },
    info: { bg: 'rgba(59,130,246,0.15)', border: '#4988C4', icon: '#4988C4', iconName: 'info' },
};
                    ...
                    <Animated.View style={[styles.container, {
                        ...
                        <View style={styles.row}>
                            ...
                            <AnimatedPressable onPress={hideToast} style={styles.closeBtn} hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
                                <MaterialIcons name="close" size={18} color="#A9B4C2" />
                            </AnimatedPressable>
                        </View>
...
const styles = StyleSheet.create({
    ...
    message: { fontSize: 13, color: '#A9B4C2', lineHeight: 18 },
    closeBtn: { padding: 4 },
