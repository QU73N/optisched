...
const AIScheduleChat: React.FC = () => {
    ...
    const renderInline = (text: string): (string | React.ReactElement)[] => {
        ...
        while ((match = regex.exec(text)) !== null) {
            ...
            else if (match[3]) parts.push(<Text key={key++} style={{ fontStyle: 'italic', color: '#BDE8F5' }}>{match[3]}</Text>);
...
const styles = StyleSheet.create({
    ...
    header: {
        ...
        paddingHorizontal: 20, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: '#263241'
    },
    ...
    aiBubble: { backgroundColor: '#263241', borderBottomLeftRadius: 4, borderWidth: 1, borderColor: '#1E2935' },
    ...
    sugChip: {
        backgroundColor: '#263241', borderRadius: 20, paddingHorizontal: 14, paddingVertical: 8,
        borderWidth: 1, borderColor: '#1E2935'
    },
    sugText: { fontSize: 12, color: Colors.slate300, fontWeight: '500' },
    inputRow: {
        flexDirection: 'row', alignItems: 'center', gap: 10,
        paddingHorizontal: 16, paddingVertical: 12, borderTopWidth: 1, borderTopColor: '#263241'
    },
    input: {
        flex: 1, backgroundColor: '#263241', borderRadius: 24, paddingHorizontal: 18, paddingVertical: 12,
        color: Colors.white, fontSize: 14, borderWidth: 1, borderColor: '#1E2935'
    },
    sendBtn: {
