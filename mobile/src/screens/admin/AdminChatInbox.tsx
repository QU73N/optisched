                            ...
                            <View key={req.id} style={[styles.resetCard, { borderColor: colors.border }]}>
                                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 12 }}>
                                    <View style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: 'rgba(245,158,11,0.12)', justifyContent: 'center', alignItems: 'center' }}>
                                        <MaterialIcons name="lock-open" size={20} color="#E6A23C" />
                                    </View>
                                    <View style={{ flex: 1 }}>
                                    ...
                                    <View style={[styles.statusBadge, { backgroundColor: 'rgba(245,158,11,0.12)' }]}>
                                        <Text style={{ fontSize: 11, fontWeight: '600', color: '#E6A23C' }}>Pending</Text>
                                    </View>
                                </View>
                                ...
                                <View style={{ flexDirection: 'row', gap: 8 }}>
                                    ...
                                    <AnimatedPressable style={styles.denyBtn} onPress={() => handleDenyReset(req)}>
                                        ...
                                        <Text style={{ color: '#E05D5D', fontWeight: '600', fontSize: 13 }}>Deny</Text>
                                    </AnimatedPressable>
                                </View>
                            </View>
                        ))}
...
const styles = StyleSheet.create({
    ...
    bubbleTeacher: { backgroundColor: '#1E2935', borderBottomLeftRadius: 4 },
    ...
    resetCard: {
        backgroundColor: '#263241', borderRadius: 16, padding: 16,
        borderWidth: 1, marginBottom: 12
    },
    statusBadge: { borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
    approveBtn: {
        flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6,
        backgroundColor: '#3FAF73', borderRadius: 10, paddingVertical: 10
    },
    denyBtn: {
        flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6,
