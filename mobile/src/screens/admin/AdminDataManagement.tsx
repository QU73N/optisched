                            ...
                            <View key={s.id} style={styles.itemCard}>
                                <View style={styles.itemLeft}>
                                    <View style={[styles.itemIcon, { backgroundColor: 'rgba(59,130,246,0.12)' }]}>
                                        <MaterialIcons name="menu-book" size={20} color="#4988C4" />
                                    </View>
                                    <View style={{ flex: 1 }}>
                        ...
                        {activeTab === 'rooms' && rooms.map(r => (
                            <View key={r.id} style={styles.itemCard}>
                                ...
                                <View style={styles.itemActions}>
                                    ...
                                    <AnimatedPressable onPress={() => handleDelete(r.id, r.name)}><MaterialIcons name="delete-outline" size={18} color="#E05D5D" /></AnimatedPressable>
                                </View>
                            </View>
                        ))}
                        ...
                        {activeTab === 'sections' && sections.map(s => (
                            <View key={s.id} style={styles.itemCard}>
                                ...
                                <View style={styles.itemActions}>
                                    ...
                                    <AnimatedPressable onPress={() => handleDelete(s.id, s.name)}><MaterialIcons name="delete-outline" size={18} color="#E05D5D" /></AnimatedPressable>
                                </View>
                            </View>
                        ))}
...
const styles = StyleSheet.create({
    ...
    input: {
        backgroundColor: '#0B0F14', borderWidth: 1, borderColor: '#1E2935', borderRadius: 10,
        paddingHorizontal: 14, paddingVertical: 12, color: Colors.white, fontSize: 14
    },
    chip: {
        paddingHorizontal: 14, paddingVertical: 8, borderRadius: 8,
        borderWidth: 1, borderColor: '#1E2935', marginBottom: 4
    },
