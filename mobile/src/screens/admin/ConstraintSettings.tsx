        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.infoBanner}>
                    <MaterialIcons name="info" size={20} color="#4988C4" />
                ...
                <View style={styles.card}>
                    <View style={styles.toggleRow}>
                        ...
                        <Switch value={blockRestDays} onValueChange={setBlockRestDays} trackColor={{ false: '#1E2935', true: Colors.primary }} thumbColor={Colors.white} />
                    </View>
                    ...
                    <View style={styles.toggleRow}>
                        ...
                        <Switch value={forceLunch} onValueChange={setForceLunch} trackColor={{ false: '#1E2935', true: Colors.primary }} thumbColor={Colors.white} />
                    </View>
                ...
                <View style={styles.card}>
                    ...
                    <View style={[styles.toggleRow, { borderTopWidth: 1, borderTopColor: 'rgba(51,65,85,0.5)', paddingTop: 16 }]}>
                        ...
                        <Switch value={overflowAllowed} onValueChange={setOverflowAllowed} trackColor={{ false: '#1E2935', true: Colors.primary }} thumbColor={Colors.white} />
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    card: { backgroundColor: '#263241', borderRadius: 16, padding: 20, marginBottom: 24, gap: 24 },
    ...
    sliderTrack: { height: 8, backgroundColor: '#0B0F14', borderRadius: 4, overflow: 'hidden' },
    ...
    capacityInput: { flex: 1, backgroundColor: '#0B0F14', padding: 12, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(51,65,85,0.5)' },
    ...
    constraintList: { backgroundColor: '#263241', borderRadius: 16, overflow: 'hidden', marginBottom: 24 },
