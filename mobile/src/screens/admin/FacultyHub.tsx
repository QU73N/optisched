...
const FacultyHub: React.FC = () => {
    ...
    const faculty: FacultyMember[] = useMemo(() => {
        const source = teachers.map(t => {
            ...
            const loadColor = isOverloaded ? '#E05D5D' : load > 80 ? '#E6A23C' : '#3FAF73';
            return {
                id: t.id, name, department: t.department,
                type: t.employment_type as 'full-time' | 'part-time',
                load, maxHours: t.max_hours, loadColor, statusColor: t.is_active ? '#3FAF73' : '#A9B4C2',
        ...
        <SafeAreaView style={styles.container}>
                                    ...
                                    <View style={styles.badgeRow}>
                                        ...
                                        {member.isOverloaded && (
                                            <View style={styles.badgeRed}>
                                                <MaterialIcons name="warning" size={10} color="#E05D5D" />
            ...
            <Modal visible={showScheduleModal} animationType="slide" transparent>
                <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.7)' }}>
                    <SafeAreaView style={{ flex: 1 }}>
                        <View style={{ flex: 1, backgroundColor: '#0B0F14', marginTop: 40, borderTopLeftRadius: 24, borderTopRightRadius: 24 }}>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 20, borderBottomWidth: 1, borderBottomColor: '#263241' }}>
                                <View>
                                ...
                                {teacherSchedule.length === 0 ? (
                                    ...
                                    Object.entries(scheduleByDay).map(([day, daySchedules]) => (
                                        <View key={day} style={{ marginTop: 16 }}>
                                            ...
                                            {daySchedules.map(s => (
                                                <View key={s.id} style={{ backgroundColor: '#263241', borderRadius: 12, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: '#1E2935' }}>
            ...
            <Modal visible={showLoadModal} animationType="slide" transparent>
                <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'flex-end' }}>
                    <View style={{ backgroundColor: '#263241', borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingHorizontal: 24, paddingTop: 24, paddingBottom: 40 }}>
                        ...
                        <TextInput
                            style={{ backgroundColor: '#0B0F14', borderWidth: 1, borderColor: '#1E2935', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, color: Colors.white, fontSize: 16, fontWeight: '600' }}
            ...
            <Modal visible={showActionSheet} animationType="fade" transparent>
                <AnimatedPressable style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)' }} activeOpacity={1} onPress={() => setShowActionSheet(false)}>
                    <View style={{ flex: 1, justifyContent: 'flex-end' }}>
                        <View style={{ backgroundColor: '#263241', borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingTop: 16, paddingBottom: 40 }}>
                            {/* Handle bar */}
                            ...
                            {/* Actions */}
                            {[
                                { icon: 'calendar-today', label: 'View Schedule', color: '#4988C4', bg: 'rgba(59,130,246,0.12)', action: () => { setShowActionSheet(false); if (actionMember) handleViewSchedule(actionMember); } },
                            ...
                            <AnimatedPressable
                                style={{ marginHorizontal: 20, marginTop: 12, paddingVertical: 14, borderRadius: 12, borderWidth: 1, borderColor: '#1E2935', alignItems: 'center' }}
            ...
            <Modal visible={showMessageModal} animationType="slide" transparent>
                <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'flex-end' }}>
                    <View style={{ backgroundColor: '#263241', borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingHorizontal: 24, paddingTop: 24, paddingBottom: 40 }}>
                        ...
                        <TextInput
                            style={{ backgroundColor: '#0B0F14', borderWidth: 1, borderColor: '#1E2935', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, paddingTop: 12, color: Colors.white, fontSize: 14, minHeight: 100, textAlignVertical: 'top' }}
...
const styles = StyleSheet.create({
    ...
    searchInput: { backgroundColor: '#263241', borderWidth: 1, borderColor: '#1E2935', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 10, color: Colors.white, fontSize: 14, marginBottom: 12 },
    ...
    avatarOverloaded: { backgroundColor: '#E05D5D' },
    ...
    badgeTextRed: { color: '#E05D5D', fontSize: 10, fontWeight: '700', letterSpacing: 0.5 },
