                ...
                <Svg width={140} height={140} viewBox="0 0 120 120">
                    <Defs>
                        ...
                        <SvgLinearGradient id="splashHeader" x1="0%" y1="0%" x2="100%" y2="100%">
                            <Stop offset="0%" stopColor="#0F2854" />
                            <Stop offset="100%" stopColor="#0F2854" />
                        </SvgLinearGradient>
                        <SvgLinearGradient id="splashCheck" x1="0%" y1="0%" x2="100%" y2="100%">
                            <Stop offset="0%" stopColor="#3FAF73" />
                            <Stop offset="100%" stopColor="#257349" />
                        </SvgLinearGradient>
                    ...
                    {/* Grid cells row 1 */}
                    <Rect x="28" y="52" width="12" height="10" rx="3" fill="rgba(73,136,196,0.15)" />
                    <Rect x="44" y="52" width="12" height="10" rx="3" fill="rgba(73,136,196,0.15)" />
                    <Rect x="60" y="52" width="12" height="10" rx="3" fill="rgba(73,136,196,0.15)" />
                    <Rect x="76" y="52" width="12" height="10" rx="3" fill="rgba(73,136,196,0.2)" />
                    {/* Grid cells row 2 */}
                    <Rect x="28" y="66" width="12" height="10" rx="3" fill="rgba(73,136,196,0.12)" />
                    <Rect x="44" y="66" width="12" height="10" rx="3" fill="rgba(73,136,196,0.12)" />
                    <Rect x="60" y="66" width="12" height="10" rx="3" fill="#1C4D8D" />
                    <Rect x="76" y="66" width="12" height="10" rx="3" fill="rgba(73,136,196,0.12)" />
                    {/* Grid cells row 3 */}
                    <Rect x="28" y="80" width="12" height="8" rx="3" fill="rgba(73,136,196,0.08)" />
                    <Rect x="44" y="80" width="12" height="8" rx="3" fill="rgba(73,136,196,0.08)" />
                    {/* Check badge circle */}
...
const styles = StyleSheet.create({
    ...
    bgCircle1: {
        ...
        backgroundColor: 'rgba(73, 136, 196, 0.04)',
        top: -width * 0.3,
        left: -width * 0.25,
    },
    bgCircle2: {
        ...
        backgroundColor: 'rgba(73, 136, 196, 0.03)',
        bottom: -width * 0.4,
        right: -width * 0.3,
    },
    ring: {
        ...
        borderRadius: 100,
        borderWidth: 3,
        borderColor: 'rgba(73, 136, 196, 0.4)',
    },
    logoWrap: {
        alignItems: 'center',
        justifyContent: 'center',
