            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                ...
                <AnimatedPressable style={styles.profileCard} onPress={() => {
                    ...
                    <AnimatedPressable style={styles.profileAvatar} onPress={pickImage}>
                        ...
                        <View style={{ position: 'absolute', bottom: -2, right: -2, width: 22, height: 22, borderRadius: 11, backgroundColor: Colors.primary, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#0B0F14' }}>
