...
// Theme-aware color tokens — aligned with BRAND_SYSTEM.md and web design
const getLoginColors = (isDark: boolean) => ({
    // Background & surfaces
    bg: isDark ? Colors.bgPrimary : Colors.bgLightPrimary,
    orbA: isDark ? 'rgba(28,77,141,0.06)' : 'rgba(28,77,141,0.05)',   // brandCore
    orbB: isDark ? 'rgba(73,136,196,0.04)' : 'rgba(73,136,196,0.03)',  // brandBright
    glow: isDark ? 'rgba(28,77,141,0.25)' : 'rgba(28,77,141,0.12)',    // brandCore glow
    
    // Text
    title: isDark ? Colors.textPrimaryDark : Colors.textPrimaryLight,
    subtitle: isDark ? Colors.textMutedDark : Colors.textMutedLight,
    
    // Card
    card: isDark ? Colors.bgSurface : Colors.white,
    cardBorder: isDark ? Colors.borderDefault : Colors.borderLight,
    cardTitle: isDark ? Colors.textPrimaryDark : Colors.slate900,
    label: isDark ? Colors.textMutedDark : Colors.textMutedLight,
    
    // Input
    inputBg: isDark ? Colors.bgInset : Colors.bgLightSecondary,
    inputBorder: isDark ? Colors.borderDefault : Colors.borderLight,
    inputFocusBorder: Colors.accentPrimaryHover,  // brandBright
    inputFocusBg: isDark ? 'rgba(28,77,141,0.1)' : 'rgba(28,77,141,0.05)',
    inputText: isDark ? Colors.textPrimaryDark : Colors.textPrimaryLight,
    placeholder: isDark ? Colors.textMutedDark : Colors.slate400,
    iconDefault: isDark ? Colors.textMutedDark : Colors.slate400,
    iconFocus: Colors.accentPrimaryHover,  // brandBright
    
    // Badge/accent
    badgeBg: isDark ? 'rgba(73,136,196,0.08)' : 'rgba(73,136,196,0.06)',  // brandBright
    badgeText: Colors.accentSecondary,  // brandBright
    forgotText: Colors.accentSecondary,
    
    // Status
    errorBg: isDark ? 'rgba(200,75,75,0.08)' : 'rgba(200,75,75,0.06)',
    errorBorder: 'rgba(200,75,75,0.15)',
    errorText: isDark ? '#ff8080' : Colors.error,
    
    // Divider
    divider: isDark ? Colors.borderDefault : Colors.borderLight,
    dividerText: isDark ? Colors.textMutedDark : Colors.slate400,
    footerText: isDark ? Colors.textMutedDark : Colors.slate400,
    eyeIcon: isDark ? Colors.textMutedDark : Colors.slate400,
    
    // Modal
    modalOverlay: isDark ? 'rgba(0,0,0,0.75)' : 'rgba(0,0,0,0.4)',
    modalBg: isDark ? Colors.bgElevated : Colors.white,
    modalBorder: isDark ? Colors.borderDefault : Colors.borderLight,
    modalText: isDark ? Colors.textPrimaryDark : Colors.textPrimaryLight,
    modalSubtext: isDark ? Colors.textSecondaryDark : Colors.textSecondaryLight,
    modalInfoBg: isDark ? 'rgba(73,136,196,0.1)' : 'rgba(73,136,196,0.06)',
    modalInfoLabel: Colors.accentSecondary,  // brandBright
    modalInfoText: isDark ? Colors.textSecondaryDark : Colors.textSecondaryLight,
    modalInputBg: isDark ? Colors.bgInset : Colors.bgLightSecondary,
    modalInputBorder: isDark ? Colors.borderDefault : Colors.borderLight,
    modalInputText: isDark ? Colors.textPrimaryDark : Colors.textPrimaryLight,
    modalCancel: isDark ? Colors.textSecondaryDark : Colors.textSecondaryLight,
});
