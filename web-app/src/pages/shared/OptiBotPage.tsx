    ...
    return (
        <div className="optibot-page">
            ...
            <style>{`
                ...
                .optibot-header { display: flex; justify-content: space-between; align-items: center; padding: 1.25rem 1.5rem; border-bottom: 1px solid var(--border-light); }
                ...
                .reset-btn { background: rgba(255,255,255,0.05); border: 1px solid var(--border-light); border-radius: 8px; padding: 8px; color: var(--text-muted); cursor: pointer; }
                ...
                .optibot-msg.user .optibot-msg-bubble { background: var(--brand-primary); color: white; border-bottom-right-radius: 4px; }
                .optibot-msg.bot .optibot-msg-bubble { background: rgba(30,41,59,0.8); border: 1px solid var(--border-light); border-bottom-left-radius: 4px; }
                .optibot-msg-bubble code { background: rgba(99,102,241,0.15); color: #a5b4fc; padding: 1px 6px; border-radius: 4px; font-size: 0.85em; }
                .optibot-msg-bubble h2, .optibot-msg-bubble h3, .optibot-msg-bubble h4 { color: #c4b5fd; margin: 8px 0 4px; }
                .optibot-msg-bubble li { margin-left: 1rem; }
                .optibot-msg-bubble strong { color: #c4b5fd; }
                .optibot-msg-bubble.typing { display: flex; align-items: center; gap: 0.5rem; color: #818cf8; font-style: italic; font-size: 0.85rem; }
                ...
                .quick-btn { padding: 0.5rem 1rem; border-radius: 12px; border: 1px solid var(--border-light); background: rgba(30,41,59,0.5); color: var(--text-secondary); font-size: 0.8rem; cursor: pointer; transition: all 0.2s; }
                .quick-btn:hover { background: rgba(139,92,246,0.1); border-color: #8b5cf6; color: #c4b5fd; }
                .optibot-input { display: flex; gap: 0.75rem; padding: 1rem 1.5rem; border-top: 1px solid var(--border-light); }
                .optibot-input input { flex: 1; padding: 0.875rem 1.25rem; background: rgba(255,255,255,0.05); border: 1px solid var(--border-light); border-radius: 24px; color: white; font-size: 0.95rem; outline: none; }
