    ...
    return (
        <div className="dashboard fade-in">
            <div className="dashboard-header">
                <div>
                    <h1 className="dashboard-title">Welcome, {profile?.full_name?.split(' ')[0] || 'Student'}</h1>
            ...
            <div className="card">
                <h3 className="card-title">My Class Schedule</h3>
                {loading ? (
                    ...
                    <p style={{ color: 'var(--text-muted)', textAlign: 'center', padding: 40 }}>
                        {profile?.section
                            ? 'No schedule published for your section yet.'
                            : 'Your section has not been assigned. Contact admin.'}
                    </p>
                ) : (
